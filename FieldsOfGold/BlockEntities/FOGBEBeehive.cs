...
namespace FieldsOfGold.BlockEntities
{
    class FOGBEBeehive : BlockEntity, IAnimalFoodSource
    {
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            if (wasPlaced)
            {
                harvestableAtTotalHours = api.World.Calendar.TotalHours + (FieldsOfGoldConfig.Current.hiveHoursToHarvest * (.2 * api.World.Rand.NextDouble()));
            }
        ...
        public override void GetBlockInfo(IPlayer forPlayer, StringBuilder dsc)
        {
            ...
            {
                str += "\n" + Lang.Get("fieldsofgold:hivewrongseason");
            }
            else if (skepToPop != null && Api.World.Calendar.TotalHours > cooldownUntilTotalHours)
            {
